                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" data-toggle="modal" data-target="#modal">
                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR4RLdcADFuofIEayYB56NsmNwD5u5GL6KMQe5d6w0&s"
                            width="30" />
                        <span id="cartCount"
                            class="badge badge-pill badge-secondary"><?php echo count($_SESSION['carrito']); ?></span>
            ...
            <div class="modal-body">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        $<?php echo $producto['precio_por_gramo'] * $producto['cantidad_disponible']; ?> - Cantidad:
                        <?php echo $producto['cantidad_disponible']; ?> Gramos
                    </li>
                    <?php
                            // Calcular el total del carrito multiplicando el precio por gramo por la cantidad de cada producto
                            $total += $producto['precio_por_gramo'] * $producto['cantidad_disponible'];
                        }
                        ?>
                </ul>
