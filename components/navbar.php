            ...
            <ul class="navbar-nav ml-auto" style="display: flex;align-items: center;<?php if ($vista == 1) {
                ...
                <div class="dropdown">
                    ...
                    <div id="myDropdown" class="dropdown-content">
                        ...
                        <a class="dropdown-item"
                            href="<?php if($vista==0){ echo "historial.php";}else{ echo "estadoPedidos.php";} ?>">Historial</a>
                        <a class="dropdown-item" href="functions/logout.php">Cerrar Sesion</a>
                    </div>
                </div>
                <li style="<?php if ($vista == 0) {
                                echo "display:none;";
                            } ?>" class="nav-item">
                    <a class="nav-link" href="crearProducto.php">Crear Producto</a>
                </li>
                ...
                <li  class="nav-item">
                    <a class="nav-link" style="display:<?php if($vista==0){echo "none";}else{echo "block";} ?>"href="estadisticasEmpleados.php">Reportes</a>
                </li>
